...
public class MomentCard extends Composite implements PaintListener
{
    ...
    public MomentCard(Composite parent, int style, Game game, MomentCardTuple tuple) throws MalformedURLException, TupleSpaceException
    {
        super(parent, style);
        ...
        signLabel.setTupleLocation(CARD_BORDER_THICKNESS * 2, CARD_BORDER_THICKNESS * 2);
    ...
    /*
     * The Mac OS X implementation of SWT does not simply pass the parameters of this method onto the method setTupleLocation(int x, int y)
     */
    @Override
    public void setTupleLocation(Point point)
    {
        setTupleLocation(point.x, point.y);
    }

    @Override
    public void setTupleLocation(int x, int y)
    {
