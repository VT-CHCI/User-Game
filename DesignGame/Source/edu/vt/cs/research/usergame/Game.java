...
public class Game
{
    ...
    private void createMomentCards(MomentCardTuple[] momentCardTuples, Image[] momentCardImages) throws MalformedURLException, TupleSpaceException
    {
        ...
        for (int i = 0; i < numMomentCards; ++i)
        {
            ...
            stageMomentCards[i] = new MomentCard(stage, SWT.NONE, this, stageMomentCardTuple,boardMomentCards[i]);
            stageMomentCards[i].setImage(new URL(momentCardTuples[i].getSource()), momentCardImages[i]);

            boardMomentCards[i] = new MomentCard(board, SWT.NONE, this, boardMomentCardTuple,stageMomentCards[i]);
        ...
        MomentCard stageDragCard = new MomentCard(stage, SWT.NONE, this, stageDragCardTuple,null);//may want to fix this -John
        ...
        MomentCard boardDragCard = new MomentCard(board, SWT.NONE, this, boardDragCardTuple,null);//may wantto fix this -John
